...
async function generateSamples (fields, files) {
  ...
  runShellCommand('export PATH="/usr/share/rvm/gems/ruby-2.4.2/bin:/usr/share/rvm/gems/ruby-2.4.2@global/bin:/usr/share/rvm/rubies/ruby-2.4.2/bin:$PATH" & /usr/share/rvm/rubies/ruby-2.4.2/bin/bundle exec /usr/share/rvm/rubies/ruby-2.4.2/bin/middleman build', 20, process.cwd() + '/docs');
